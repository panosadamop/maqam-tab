"""
MaqamTAB Backend API
FastAPI server for audio analysis, maqam detection, and PDF/LilyPond export
"""
...
app = FastAPI(title="MaqamTAB API", version="1.0.0")
...
@app.get("/health")
def health():
    return {"status": "ok", "service": "MaqamTAB API"}
