  ...
  oud: {
    ...
    tunings: [
      ...
      // Turkish standard: F2 B2 E3 A3 D4 G4  (Fa Si Mi La Re Sol)
      {
        ...
        region: "Turkish",
        description: "C#2-F#2-B2-E3-A3-D4. Κλασσικό τουρκικό κούρδισμα fasıl/sanat.",
        strings: [
      ...
      },
      {
        ...
        name: "Turkish — C♮ F#",
        region: "Turkish",
        description: "C2-F#2-B2-E3-A3-D4. Παραλλαγή με φυσικό C2 στη βάση.",
        strings: [
          { midi: 36, name: "C2",  course: 1 },
          { midi: 42, name: "F#2", course: 2 },
          { midi: 47, name: "B2",  course: 3 },
      ...
      },
      {
        ...
        name: "Turkish — C♮ F♮",
        region: "Turkish",
        description: "C2-F2-B2-E3-A3-D4. Παραλλαγή με C2 και F2 (χαμηλότερη βάση).",
        strings: [
          { midi: 36, name: "C2",  course: 1 },
          { midi: 41, name: "F2",  course: 2 },
          { midi: 47, name: "B2",  course: 3 },
      ...
      // ── IRAQI / BAGHDADI ─────────────────────────────────────────────────
      {
        ...
        name: "Iraqi Standard",
        region: "Iraqi",
        description: "Σχολή Βαγδάτης: F2-C3-D3-G3-C4-F4. Χαρακτηριστικό κούρδισμα ιρακινού μακάμ.",
        strings: [
          { midi: 41, name: "F2",  course: 1 },
      ...
      },
      {
        ...
        region: "Arabic",
        description: "Λιβανέζικο κούρδισμα: E2-A2-D3-G3-C4-F4. Χαρακτηριστικό της σύγχρονης λιβανέζικης σχολής.",
        strings: [
          { midi: 40, name: "E2",  course: 1 },
          { midi: 45, name: "A2",  course: 2 },
          { midi: 50, name: "D3",  course: 3 },
  ...
  saz: {
    ...
    tunings: [
      ...
      },
      {
        ...
        region: "Tambouras",
        description: "Ταμπουράς/Σάζι: D2-G2-C3. Κλασσικό κούρδισμα ταμπουρά.",
        strings: [
          { midi: 38, name: "D2", course: 1 },
          { midi: 43, name: "G2", course: 2 },
          { midi: 48, name: "C3", course: 3 },
      ...
      },
      {
        ...
        region: "Tambouras",
        description: "Ταμπουράς/Σάζι: D2-A2-D3. Open D κούρδισμα.",
        strings: [
          { midi: 38, name: "D2", course: 1 },
          { midi: 45, name: "A2", course: 2 },
          { midi: 50, name: "D3", course: 3 },
      ...
      },
      {
        ...
        region: "Tambouras",
        description: "Ταμπουράς/Σάζι: A2-D3-G3. Τεταρτιαίο κούρδισμα.",
        strings: [
          { midi: 45, name: "A2", course: 1 },
          { midi: 50, name: "D3", course: 2 },
          { midi: 55, name: "G3", course: 3 },
